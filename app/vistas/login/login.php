      ...
      <div class="card-body login-card-body">
        ...
        <form id="formIniciarSesion">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block" id="btnIniciarSesion">Iniciar sesión</button>
              <a href="../register/register.php" class="btn btn-secondary btn-block" id="btnRegistrarse">Registrarse</a>
            </div>
            <!-- /.col -->
          </div>
        </form>
