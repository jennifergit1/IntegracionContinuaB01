        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnSolicitarCita" name="btnSolicitarCita">Solicitar cita</button>
                </div>
            </form>
        </div>
    </div>
